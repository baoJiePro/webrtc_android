...
//            window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
     ...
     */
    public static void setStatusBarLightMode(Activity activity, @ColorRes int compatColorId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (MIUISetStatusBarLightMode(activity, true)) {
                ...
                //5.0
                activity.getWindow().setStatusBarColor(ContextCompat.getColor(activity, compatColorId));
            } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                //4.4
                //调用修改状态栏颜色的方法
                setKitkatStatusBarColor(activity, ContextCompat.getColor(activity, compatColorId));
            }
        }
    }
     ...
     * @param activity
     */
    public static void setMainPageStatusBar(Activity activity) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return;
        }
     ...
     */
    public static void setStatusBarLightMode(Activity activity, String type) {
        if (type.equals("1")) {
    ...
    static void setKitkatStatusBarColor(Activity activity, int statusColor) {
        Window window = activity.getWindow();
        //设置Window为全透明
